    ...
    <div className="erp-bg min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-extrabold text-white drop-shadow">NexaERP</h1>
        ...
        <p className="text-center text-white/30 text-[10px] mt-5">NexaERP v3.0 · Secured · Role-Based · Zero Trust</p>
      </div>
    </div>
  );
}
